...
const SITE_CONTENT = {
  ...
  about: {
    ...
    ceoGreetingBody: "안녕하십니까?\n(주)성일기전 홈페이지를 방문해 주신 고객 여러분께 감사의 인사를 드립니다.\n\n(주)성일기전은 축산 농가에 가장 필요한 환기 솔루션을 제공하겠다는 일념으로 지난 30여 년간 한 길만을 걸어왔습니다.\n그동안 대한민국 축산 현장에 최적화된 환기 시스템을 공급하며 고객 여러분과 함께 성장해 온 시간은 저희의 가장 큰 자부심입니다.\n지난 성장을 견인해 온 정직과 신뢰의 경영 철학은 변화하는 시대 흐름 속에서 더 큰 도약을 이뤄내는 든든한 뿌리가 되고 있습니다.\n\n이제 축산업은 데이터와 기술이 결합한 '스마트 팜'의 시대로 접어들었습니다.\n그간 쌓아온 독보적인 환기 기술력에 ICT기술을 접목한 차세대 브랜드 '블레온(BLEON)'을 통해,\n축산 환경의 새로운 기준을 세우고 농가의 수익성과 경쟁력을 극대화하고자 합니다.\n\n(주)성일기전은 언제나 농가의 든든한 상생 파트너가 될 것을 약속드립니다.\n고객 여러분과 더 가깝게 소통하며 기술로 보답하는 성일기전이 되겠습니다.\n\n감사합니다.",
    ...
    historyTitle: "회사 연혁",
    history: [
      { year: "1996", events: ["성일기전 회사 설립"] },
      { year: "1999", events: ["환기팬 개발 및 일본 수출 시작"] },
      { year: "2000", events: ["일본 해외 직 수출 개시"] },
      { year: "2001", events: ["중국·대만 등 아시아 지역 수출 확대 및 직영지사 설립"] },
      { year: "2002", events: ["유럽 CE 인증 획득"] },
      { year: "2003", events: ["유럽 주요 환기·환경 기업들과 수출 계약 체결"] },
  ...
  products: [
    {
      ...
      specs: {
        "모델": "SLF 오토휀 시리즈",
        "사이즈": "12인치, 14인치, 16인치, 18인치, 20인치, 24인치, 30인치, 36인치, 48인치",
        "모터 타입": "AC 모터 / BLDC 모터",
        "전압": "220V / 380V",
        "풍량": "모델별 상이",
        "소음": "저소음 설계",
        "인증": "CE 인증 (AC 모터), CE/KC 인증 (BLDC 모터)"
      }
    },
    {
      name: "휀 컨트롤러",
